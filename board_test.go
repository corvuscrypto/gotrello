...
func testBoards(t *testing.T) {
	...
	testModels := []model{
		...
		b.Members.ID(ID),
		b.Memberships.ID(ID),
		b.CalendarKey.Generate,
		b.EmailKey.Generate,
		b.MarkAsViewed,
		b.PowerUps.Calendar,
		b.PowerUps.CardAging,
		b.PowerUps.Recap,
		b.PowerUps.Voting,
	}
	...
	testExpects := []string{
		...
		bs + "/myPrefs/showSidebarBoardActions",
		...
		bs + "/labelNames/blue",
		bs + "/labelNames/green",
		bs + "/labelNames/orange",
		bs + "/labelNames/purple",
		bs + "/labelNames/red",
		bs + "/labelNames/yellow",
		bs + "/members/" + ID,
		bs + "/memberships/" + ID,
		bs + "/calendarKey/generate",
		bs + "/emailKey/generate",
		bs + "/markAsViewed",
		bs + "/powerUps/calendar",
		bs + "/powerUps/cardAging",
		bs + "/powerUps/recap",
		bs + "/powerUps/voting",
	}
